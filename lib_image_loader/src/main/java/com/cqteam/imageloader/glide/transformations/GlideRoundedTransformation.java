package com.cqteam.imageloader.glide.transformations;
...
public class GlideRoundedTransformation extends BitmapTransformation {
    ...
    private int margin;
    private GlideRoundedTransformation.CornerType cornerType;

    public GlideRoundedTransformation(int radius, int margin) {
        this(radius, margin, GlideRoundedTransformation.CornerType.ALL);
    }

    public GlideRoundedTransformation(int radius, int margin, GlideRoundedTransformation.CornerType cornerType) {
        this.radius = radius;
